...
class LP_Helpdesk(models.Model):
  ...
  lp_previntive_action = fields.Boolean('Requries Preventive Action')
  ...
  lp_corrective_action = fields.Text("Corrective Action")
  lp_preventative_actions = fields.Text("Preventive Actions")
  ...
  def message_new(self, msg, custom_values=None):
      ...
      if not msg.get('description', None):
          custom_values['description'] = html2plaintext(msg.get('body'))

      return super(LP_Helpdesk, self).message_new(msg, custom_values=custom_values)
